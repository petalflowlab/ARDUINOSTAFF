void renderCurrentEffect() {
  ...
  if (currentPage == PAGE_1) {
    switch (currentEffect) {
      ...
      case 4:  renderForestFairiesEffect(dt);     break;
      case 5:  renderPingPongEffect(dt);         break;
      case 6:  render80sBlocksEffect(dt);          break;
      case 7:  renderSlinkyEffect(dt);           break;
      case 8:  renderInkDropEffect(dt);          break;
      case 9:  renderRippleTankEffect(dt);       break;
      case 10: renderSupernovaEffect(dt);        break;
      case 11: renderBioluminescenceEffect(dt);  break;
      case 12: renderSolarFlareEffect(dt);       break;
    }
    ...
    switch (currentEffect) {
      case 0: renderPlasmaWavesEffect(dt);         break;
      case 1: renderElectronOrbitEffect(dt);       break;
      case 2: renderDNAHelixEffect(dt);            break;
      case 3: renderMeteorShowerEffect(dt);        break;
      case 4: renderMagneticPullEffect(dt);        break;
      case 5: renderMolecularVibrationEffect(dt);  break;
      case 6: renderBlackHoleEffect(dt);           break;
    }
  }
  lastUpdate = now;
}
